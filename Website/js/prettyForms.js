...
*******************/
	...
	imageCheckboxChecked="images/form_element/checkboxChecked.gif";
	imageCheckboxUnchecked="images/form_element/checkboxUnchecked.gif";
	imageRadioChecked="images/form_element/radiobuttonChecked.png";
	imageRadioUnchecked="images/form_element/radiobuttonUnchecked.png";
	imageSelectDropDownArrow="images/form_element/selectDrop.gif";
	imageCheckboxDisabled="images/form_element/disabled.gif";
...
//****	
	...
	function fixTextBoxes(){
		...
		for(i=0;i<inputs.length;i++){
			...
			if((inputs[i].type=="text" || inputs[i].type=="password" || inputs[i].type=="email") && inputs[i].className != "searchTxt"){
				appendParentsTo(inputs[i]);
			}
		}
	}
	
	//apply to a text input id
	function fixIdTextBoxes(inputId){
		inputs = document.getElementById(inputId);
	
		
			if((inputs.type=="text" || inputs.type=="password" || inputs[i].type=="email") && inputs.className != "searchTxt"){
				appendParentsTo(inputs);
			}
