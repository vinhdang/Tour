...
namespace Website.Areas.Administrator.Controllers
{
    ...
    public class NewController : Controller
    {
        ...
        //    int ID = Protector.Int(CategoryList, -1);
        //    if (ID > 0)
        //    {

        //        list = list.Where(n => n.ID == categoryID);
        //    }
        ...
        //    {
        //        current.Categories = categoryService.GetAllByType(1).ToSelectListItems(current.ID);
        ...
        //    }
        //    var list = newService.All;
        //    ViewBag.CategoryList = categoryService.GetAllByType(1).ToSelectListItems(_new.ID);
        //    ViewBag.Status = Service.Helpers.GlobalVariables.Active;
